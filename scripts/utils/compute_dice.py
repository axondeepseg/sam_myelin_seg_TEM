...
def get_parser():
    ...
    parser.add_argument('--path-dataset', type=str, help='Path to original (BIDS) dataset.')
    parser.add_argument('--path-preds', type=str, help='Path to predictions.')
    parser.add_argument('--path-baseline-preds', type=str, help='Path to baseline IVADOMED predictions.')
    parser.add_argument('--is-nnunet', default=False, action='store_true', help='if preds come from nnUNetv2 model')
